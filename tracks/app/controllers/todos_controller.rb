class TodosController < ApplicationController
  ...
  def index
    ...
    @contexts_to_show = current_user.contexts.active.limit(50)
    @projects_to_show = current_user.projects.active.limit(50)
  ...
  def new
    @projects = current_user.projects.active.limit(10)
    @contexts = current_user.contexts.limie(10)
    respond_to do |format|
      format.m {
        @new_mobile = true
  ...
  def list_deferred
    ...
    @contexts_to_show = @contexts = current_user.contexts.limit(50)
    @projects_to_show = @projects = current_user.projects.limit(50)
  ...
  def tag
    ...
    todos_with_tag_ids = find_todos_with_tag_expr(@tag_expr).limit(20)
    ...
    @projects = current_user.projects.limit(10)
    @contexts = current_user.contexts.limit(10)
    @contexts_to_show = @contexts.active.limit(10)
    @projects_to_show = @projects.active.limit(10)
